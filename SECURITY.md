...
LOTA is security-sensitive infrastructure. Reports that affect the
attestation chain, TPM enrollment, verifier policy, BPF LSM enforcement,
release integrity, or SDK token validation should use a private channel.
...
- GitHub Private Vulnerability Reporting for
  `github.com/szymonwilczek/lota`.

Fallback encrypted channel:

- Email: `swilczek.lx@gmail.com`
- GPG fingerprint:
  `3EE5 3281 2DF0 F36A B7A1 F178 B8E9 4407 1CB7 EB8A`
...
See [`docs/BUILD-REPRODUCIBLE.md`](docs/BUILD-REPRODUCIBLE.md) for release
